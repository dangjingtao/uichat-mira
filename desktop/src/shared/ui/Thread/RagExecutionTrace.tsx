...
import type { RagProgressDetail } from "@/shared/ui/RagProgressDetailDrawer";
...
export function RagExecutionTrace({
  ...
  return (
    <div className="mt-2 overflow-hidden rounded-2xl border border-border/70 bg-surface-primary/70">
      <button
        type="button"
                ...
                <p className="min-w-0 shrink text-sm text-text-primary">
                  ...
                  {step.summary ? (
                    <span className="truncate text-text-secondary">
                      {" · "}
                      {normalizeInlineText(step.summary)}
                    </span>
                  ) : null}
                </p>
