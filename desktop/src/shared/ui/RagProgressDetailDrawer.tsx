...
import type { RagNodeEnvironment } from "@/shared/ui/Thread/thread.types";

export type RagProgressStatus = "start" | "done" | "error";

export type RagProgressDetail = {
  messageId: string;
  nodeId: string;
  nodeType: string;
  label: string;
...
export function RagProgressDetailDrawer({
  open,
  detail,
  onClose,
}: {
...
export default RagProgressDetailDrawer;
