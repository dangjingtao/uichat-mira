...
export default function WelcomeEmptyState({
  ...
  return (
    <div
      key={isVisible ? `welcome-${activeThreadId ?? "empty"}` : "welcome-hidden"}
    ...
    >
      <div className="relative min-h-[18rem] w-full overflow-hidden rounded-[28px] lg:min-h-[26rem]">
        ...
        <div className="relative z-[1] flex min-h-[18rem] max-w-[32rem] flex-col justify-center gap-4 px-2 py-4 lg:min-h-[26rem] lg:max-w-[34rem] lg:justify-start lg:pt-[5.4rem]">
          ...
          <div className="space-y-4">
            <h1 className="max-w-[15ch] text-[30px] font-semibold tracking-tight text-text-primary sm:text-[38px] sm:leading-[1.16] lg:max-w-[15ch] lg:text-[42px]">
            ...
            <p className="max-w-[30rem] text-[15px] leading-7 text-text-secondary lg:max-w-[26rem]">
