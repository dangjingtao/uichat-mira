const settingsPending = {
  settings: {
    ...
    navigation: {
      ...
      tailscaleRemoteAccess: "Tailscale Remote Access",
      dashboard: "Dashboard",
      model: "Model",
    ...
    personalization: {
      page: {
        miniTitle: "Personalization",
        title: "Personalization",
        description: "Shape how Mira communicates with you and share the personal context you want it to know.",
      },
      previewOnly: "UI preview",
      communication: {
        title: "Communication preferences",
      },
      tone: {
        label: "Base style and tone",
        description: "Choose how Mira should respond; this currently affects this page preview only.",
        options: {
      ...
      instructions: {
        ...
        placeholder: "For example: be thoughtful and witty, lead with the answer, then add essential details",
      },
      aboutYou: {
        title: "About you",
        nickname: "Nickname",
        nicknamePlaceholder: "How should Mira address you?",
        occupation: "Occupation",
        occupationPlaceholder: "For example: product designer or engineering student",
        details: "More about you",
        detailsPlaceholder: "Interests, values, or preferences worth remembering",
      },
      memory: {
        title: "Memory",
        enable: "Enable memory",
        enableDescription: "Allow Mira to form memories about you from future conversations and materials.",
        summary: "Memory summary",
        summaryDescription: "Review what Mira knows about you and preview how those memories could be managed.",
        manage: "Manage",
        close: "Close memory summary",
        drawerTitle: "Memory summary",
        drawerDescription: "This is a frontend preview and does not read or write real memories.",
        overviewTitle: "What Mira remembers about you",
        overviewDescription: "Stable preferences, background, and areas of interest will be organized here to keep future conversations consistent.",
        updateLabel: "Add or update",
        updatePlaceholder: "Enter something you would like Mira to remember",
        updateHint: "This field is for presentation only and does not save content yet.",
        done: "Done",
      },
    },
    tailscaleRemoteAccess: {
      page: {
        ...
        description: "Preview how Mira could be reached from other devices through a private tailnet.",
      },
      preview: {
        badge: "Not connected",
      },
      status: {
        ...
        connectionDescription: "Once runtime support is implemented, this area can show the device's tailnet connection state.",
        notConnected: "Disconnected",
        enable: "Enable remote access",
        enableDescription: "This switch only changes the page preview and does not expose a network port.",
      },
      device: {
        title: "Device configuration",
        name: "Device name",
        namePlaceholder: "For example: mira-desktop",
        tailnet: "Tailnet domain",
        tailnetPlaceholder: "For example: example.ts.net",
        previewAddress: "Expected access address",
        previewHint: "This address is generated for interface preview and is not an active link.",
      },
      access: {
        title: "Access scope",
        scope: "Allowed members",
        description: "Real access should be controlled by both Tailscale ACLs and app authentication. This selection does not write any policy.",
        options: {
          owner: "Current user only",
          tailnet: "Tailnet members",
        },
      },
      guide: {
        drawerTitle: "Help",
        intro: "Use these steps to prepare your private network. Runtime remote access support will be added later.",
        close: "Close Tailscale help",
        steps: {
          install: {
            title: "Install Tailscale",
            description: "Install the Tailscale client on the Mira computer and the remote device.",
          },
          login: {
            title: "Join one tailnet",
            description: "Sign in with a trusted account and confirm both devices share the same private network.",
          },
          publish: {
            title: "Configure app access",
            description: "Add service publishing, app authentication, and access policy support before enabling remote access.",
          },
        },
      },
      actions: {
    ...
    microApps: {
      ...
      studioEntries: {
        ...
        newsHub: {
          title: "Guanlan",
          description: "Bring multiple technology news sources into a local feed for browsing, search, and AI summaries.",
          actions: {
            open: "Open Guanlan",
          },
        },
      ...
      newsHub: {
        page: {
          miniTitle: "Guanlan",
          title: "Guanlan",
          description: "Collect technology news from multiple sources into a local feed built for browsing, search, and AI analysis.",
        },
        banner: {
        ...
        feeds: {
          ...
          description: "Paste a blog homepage or feed URL. Guanlan will discover and ingest public feeds.",
          add: "Add subscription",
          loading: "Loading subscriptions...",
          empty: "No custom subscriptions yet.",
          urlLabel: "Website or feed URL",
          detect: "Detect feed",
          detecting: "Detecting...",
          detectHint: "Enter a website homepage or RSS / Atom URL, then detect its feeds.",
          cancel: "Cancel",
          candidates: "Detected feeds",
          nameLabel: "Display name",
          topicLabel: "Category",
          langLabel: "Language",
          auto: "Auto detect",
          preview: "Recent article preview",
          subscribe: "Subscribe",
          refresh: "Refresh now",
          edit: "Edit",
          open: "Open website",
          ...
          deleteDescription: "Delete “{{name}}” and all articles already fetched from it. This cannot be undone.",
          deleteConfirm: "Delete feed and articles",
          created: "Subscription added",
          updated: "Subscription updated",
          deleted: "Subscription and its articles deleted",
          loadFailed: "Failed to load subscriptions",
          detectFailed: "No usable RSS / Atom feed was found",
        ...
        messages: {
          loadFailed: "Failed to load Guanlan",
    ...
    mcp: {
      ...
      marketplace: {
        ...
        syncing: "Updating the marketplace in the background; showing local data",
        syncFailed: "Marketplace update failed; showing the last successful data",
        lastUpdated: "Marketplace updated:",
        categories: {
          all: "All categories",
          developerTools: "Developer tools",
          data: "Data and databases",
          searchKnowledge: "Search and knowledge",
          browserAutomation: "Browser and automation",
          filesOffice: "Files and office",
        ...
        detailsDrawer: {
          close: "Close MCP details",
          details: "MCP Server details",
          description: "Description",
          identity: "Version and maintenance",
          version: "Version",
          status: "Status",
          publishedAt: "Published",
          updatedAt: "Updated",
          ...
          installable: "Installable",
          notInstallable: "Not currently installable",
