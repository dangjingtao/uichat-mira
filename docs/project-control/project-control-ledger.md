...
| Codebase Understanding Docs | `READY_FOR_REVIEW` | `code_T001`、`code_T002`、`code_T003`、`code_T004` 已完成 scoped docs 卡；`code_T006` 已补本地 CodeGraph benchmark spike 独立 review，结论为继续做受控候选，不接 runtime | [code_T001](tasks/code_T001-codebase-understanding-consensus-doc-integration.md), [code_T002](tasks/code_T002-codebase-engine-benchmark.md), [code_T003](tasks/code_T003-codegraph-managed-mcp-spike.md), [code_T004](tasks/code_T004-codebase-engine-abstraction.md), [code_T006](tasks/code_T006-codegraph-benchmark-spike.md), [review](reviews/codebase-understanding-docs-review-index.md), [codegraph benchmark spike](reviews/codegraph-benchmark-spike.md) | 文档正文统一落入 `docs/tooling-runtime/`；总审查材料按仓库规则落入 `reviews/`，不沿用外部 `docs/agent/`；`code_T006` 是本地 benchmark spike 记录任务，不是 runtime 接入任务 |
