...
| Codebase Understanding Docs | `IN_PROGRESS` | `code_T014` 已完成真实 provider smoke：真实 `codegraph 1.3.0` 在 `telemetry = verified_off` 下可 detect / start / health 且状态为 ready，4 条 query 中 3 条产出 verified candidate；但 `Planner -> Normalize -> Policy -> ToolNode -> Evidence` flow query 仍有 raw output 有源码块而 wrapper 统计 `0 verified` 的质量缺口，且第一次真实 smoke 已在 repo 根目录新增 `.codegraph/`，当前结论必须保持 blocked | [code_T001](tasks/code_T001-codebase-understanding-consensus-doc-integration.md), [code_T002](tasks/code_T002-codebase-engine-benchmark.md), [code_T003](tasks/code_T003-codegraph-managed-mcp-spike.md), [code_T004](tasks/code_T004-codebase-engine-abstraction.md), [code_T006](tasks/code_T006-codegraph-benchmark-spike.md), [code_T007](tasks/code_T007-codegraph-wrapper-contract.md), [code_T008](tasks/code_T008-codegraph-managed-mcp-runtime-implementation-plan.md), [code_T009](tasks/code_T009-codegraph-managed-mcp-runtime-spike.md), [code_T010](tasks/code_T010-codebase-explore-wrapper-runtime.md), [code_T011](tasks/code_T011-codegraph-verification-bridge.md), [code_T012](tasks/code_T012-codegraph-trace-diagnostics.md), [code_T013](tasks/code_T013-codegraph-controlled-planner-exposure.md), [code_T014](tasks/code_T014-codegraph-real-provider-smoke.md), [code_T014 report](reviews/code_T014-codegraph-real-provider-smoke-report.md), [review](reviews/codebase-understanding-docs-review-index.md), [codegraph benchmark spike](reviews/codegraph-benchmark-spike.md), [code_T009 review](reviews/code_T009-codegraph-managed-mcp-runtime-spike-review.md), [code_T010 review](reviews/code_T010-codebase-explore-wrapper-runtime-review.md), [code_T011 review](reviews/code_T011-codegraph-verification-bridge-review.md), [code_T012 review](reviews/code_T012-codegraph-trace-diagnostics-review.md), [code_T013 review](reviews/code_T013-codegraph-controlled-planner-exposure-review.md), [code_T014 review](reviews/code_T014-codegraph-real-provider-smoke-review.md) | 不默认启用 Planner exposure；真实 provider 兼容层已经成立，但 repo-root `.codegraph/` 污染风险已被真实 smoke 触发，当前不能升级为 ready |
...
| [code_T014](tasks/code_T014-codegraph-real-provider-smoke.md) | `BLOCKED` | 已完成真实 provider smoke 与兼容层修正：真实 `codegraph 1.3.0` 在 `telemetry = verified_off` 下 detect / start / health 均为 ready，4 条 query 中 3 条产出 verified candidate；但 flow query 仍有 raw output 有源码块而 wrapper 统计 `0 verified` 的质量缺口，且第一次真实 smoke 在 repo 根目录新增 `.codegraph/`，按任务边界必须 blocked |
