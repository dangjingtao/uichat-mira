...
| Codebase Understanding Docs | `DONE` | `code_T001`、`code_T002`、`code_T003`、`code_T004` 已完成，等待总审查 | [code_T001](tasks/code_T001-codebase-understanding-consensus-doc-integration.md), [code_T002](tasks/code_T002-codebase-engine-benchmark.md), [code_T003](tasks/code_T003-codegraph-managed-mcp-spike.md), [code_T004](tasks/code_T004-codebase-engine-abstraction.md), [review](reviews/codebase-understanding-docs-review-index.md) | 文档正文统一落入 `docs/tooling-runtime/`；总审查材料按仓库规则落入 `reviews/`，不沿用外部 `docs/agent/`；`code_T004` 的 `DONE` 状态来自 2026-07-08 项目 owner 明确要求直接标记完成 |
