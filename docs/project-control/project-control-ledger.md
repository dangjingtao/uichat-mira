...
| Codebase Understanding Docs | `READY_FOR_REVIEW` | `code_T013` 已完成受控 Planner 暴露：`codebase_explore` 现在只在 `UI_CHAT_CODEGRAPH_PLANNER_ENABLED=1` 时注册，仍然必须经过 Normalize / Policy / ToolNode 主链，且只有 verification bridge 核验通过的 chunk 才能进入 Evidence | [code_T001](tasks/code_T001-codebase-understanding-consensus-doc-integration.md), [code_T002](tasks/code_T002-codebase-engine-benchmark.md), [code_T003](tasks/code_T003-codegraph-managed-mcp-spike.md), [code_T004](tasks/code_T004-codebase-engine-abstraction.md), [code_T006](tasks/code_T006-codegraph-benchmark-spike.md), [code_T007](tasks/code_T007-codegraph-wrapper-contract.md), [code_T008](tasks/code_T008-codegraph-managed-mcp-runtime-implementation-plan.md), [code_T009](tasks/code_T009-codegraph-managed-mcp-runtime-spike.md), [code_T010](tasks/code_T010-codebase-explore-wrapper-runtime.md), [code_T011](tasks/code_T011-codegraph-verification-bridge.md), [code_T012](tasks/code_T012-codegraph-trace-diagnostics.md), [code_T013](tasks/code_T013-codegraph-controlled-planner-exposure.md), [review](reviews/codebase-understanding-docs-review-index.md), [codegraph benchmark spike](reviews/codegraph-benchmark-spike.md), [code_T009 review](reviews/code_T009-codegraph-managed-mcp-runtime-spike-review.md), [code_T010 review](reviews/code_T010-codebase-explore-wrapper-runtime-review.md), [code_T011 review](reviews/code_T011-codegraph-verification-bridge-review.md), [code_T012 review](reviews/code_T012-codegraph-trace-diagnostics-review.md), [code_T013 review](reviews/code_T013-codegraph-controlled-planner-exposure-review.md) | `code_T013` 已证明受控 Planner 暴露可行，但仍是 feature-flag gated；真实 CodeGraph provider 质量、前台 trace 可视化和更大范围 rollout 仍需后续单独评估 |
...
| [code_T009](tasks/code_T009-codegraph-managed-mcp-runtime-spike.md) | `DONE` | 已完成最小 managed runtime spike 审查并回填任务卡；当前只验证 process manager lifecycle，不暴露 Planner，不接 Evidence，不改 Agent Graph，真实 `.codegraph/` repo 污染风险仍待后续任务验证 |
