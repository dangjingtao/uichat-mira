...
| --- | --- | --- | --- | --- |
| Forge / 淬行 Integration | `TODO` | Forge 并入 Mira 单仓、单依赖体系；保留 Main Thread → Repository Task → Dispatch → Builder → Review / Handoff 工程控制内核；外部 UI 待 OpenDesign 设计输入后按 Desktop 体系落地 | [T001](tasks/forge_T001-integration-contract-and-source-baseline.md), [T002](tasks/forge_T002-core-import-and-dependency-unification.md), [T003](tasks/forge_T003-runtime-lifecycle-and-persistence-ownership.md), [T004](tasks/forge_T004-project-registry-and-repository-task-source.md), [T005](tasks/forge_T005-main-thread-runtime-and-provider-adapters.md), [T006](tasks/forge_T006-builder-dispatch-and-process-supervision.md), [T007](tasks/forge_T007-review-handoff-and-runtime-state-guards.md), [T008](tasks/forge_T008-mira-server-api-and-desktop-client-contract.md), [T009](tasks/forge_T009-desktop-cuixing-product-surface.md), [T010](tasks/forge_T010-end-to-end-cutover-and-legacy-retirement.md) | Source baseline: `mira-forge dev@6557b9f`; target: `uichat-mira dev@27be0eb`; 默认串行，UI 不允许脱离 OpenDesign 文件自行设计 |
