...
export const withPlannerTaskPlanContract = (
  ...
  const planContract = [
    ...
    "When a work package has a clear boundary and is expected to require multiple sequential tools, post-execution verification, or local recovery, prefer one delegate_task action for the complete package. Put the full local objective in goal and observable completion conditions in acceptanceCriteria.",
